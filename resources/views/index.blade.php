...
<body>
    <!--header-->
    <header>
        <div class="logo"><a href="/"><img class="logo-img" src="{{ asset('site/img/logo.svg') }}"
                    alt="logo provita"></a></div>
    ...
    <footer>
        ...
        <a class="legal-links" href="https://sertsoft.com.br" target="_blank">Desenvolvido por SertSoft</a>
        ...
        <ul>
            ...
            <li>
                <a href="https://www.instagram.com/invites/contact/?i=1xd1ixvwx8n9z&utm_content=lzg5lm5"
                    target="_blank">
                    <i class="fab fa-instagram fa-2x"></i>
                </a>
            </li>
            <li>
                <a href="https://api.whatsapp.com/send?phone=551123082307&text=Olá%20Provita%20pode%20me%20ajudar%20?"
                    target="_blank">
