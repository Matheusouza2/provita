                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ old('numero') }}" id="numero" name="numero" class="form-control" placeholder="Nº" required>
                                        <div class="invalid-feedback">Campo de preenchimento obrigatório</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('complemento') }}" id="complemento" name="complemento" class="form-control" placeholder="Complemento">
                                    </div>
                                </div>
