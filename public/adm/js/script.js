...
$("#cnpj").blur(function () {
	...
	$.getJSON("http://www.receitaws.com.br/v1/cnpj/" + cnpj + "?callback=?", function (dados) {
		console.log(dados);
		$('#dados').delay(2000).html('Razão Social: '+dados.nome+'<br> Nome Fantasia: '+dados.fantasia+'<br>Endereço: '+dados.logradouro+', '+dados.numero+'<br>Bairro: '+dados.bairro+'<br>Local: '+dados.municipio+', '+dados.uf+'<br> Telefone: '+dados.telefone);
